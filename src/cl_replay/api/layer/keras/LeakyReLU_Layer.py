...
class LeakyReLU_Layer(LeakyReLU):
    ...
    def __init__(self, **kwargs):
        ...
        self.alpha          = self.parser.add_argument('--units',           type=int,   default=0.3, help='sets alpha coefficient.')

        super(LeakyReLU_Layer, self).__init__(name=self.layer_name, alpha=self.alpha)
